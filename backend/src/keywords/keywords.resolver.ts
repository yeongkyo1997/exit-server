...
export class KeywordsResolver {
  ...
  @Mutation(() => Keyword)
  createKeyword(@Args('createKeywordInput') createKeywordInput: CreateKeywordInput) {
  ...
  @Mutation(() => Keyword)
  updateKeyword(@Args('updateKeywordInput') updateKeywordInput: UpdateKeywordInput) {
    return this.keywordsService.update(updateKeywordInput.id, updateKeywordInput);
  }
