...
export class SubCommentsResolver {
  ...
  @Mutation(() => SubComment)
  createSubComment(@Args('createSubCommentInput') createSubCommentInput: CreateSubCommentInput) {
  ...
  @Mutation(() => SubComment)
  updateSubComment(@Args('updateSubCommentInput') updateSubCommentInput: UpdateSubCommentInput) {
    return this.subCommentsService.update(updateSubCommentInput.id, updateSubCommentInput);
  }

  @Mutation(() => SubComment)
  removeSubComment(@Args('id', { type: () => Int }) id: number) {
