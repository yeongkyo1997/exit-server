...
export class BoardImagesResolver {
  ...
  @Mutation(() => BoardImage)
  createBoardImage(@Args('createBoardImageInput') createBoardImageInput: CreateBoardImageInput) {
  ...
  @Mutation(() => BoardImage)
  updateBoardImage(@Args('updateBoardImageInput') updateBoardImageInput: UpdateBoardImageInput) {
    return this.boardImagesService.update(updateBoardImageInput.id, updateBoardImageInput);
  }

  @Mutation(() => BoardImage)
  removeBoardImage(@Args('id', { type: () => Int }) id: number) {
